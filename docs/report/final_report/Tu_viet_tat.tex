...
\newglossaryentry{DOM}{
    ...
    first={Mô hình đối tượng tài liệu (Document Object Model)}
}

\newglossaryentry{CSS}{
    type=\acronymtype,
    name={CSS},
    description={Mã định dạng (Cascading Style Sheets)},
    first={Mã định dạng (Cascading Style Sheets)}
}

\newglossaryentry{JVM}{
    type=\acronymtype,
    name={JVM},
    description={Máy ảo Java (Java Virtual Machine)},
    first={Máy ảo Java (Java Virtual Machine)}
}

\newglossaryentry{MVC}{
    type=\acronymtype,
    name={MVC},
    description={Mô hình thiết kế (Model-View-Controller)},
    first={Mô hình thiết kế (Model-View-Controller)}
}
