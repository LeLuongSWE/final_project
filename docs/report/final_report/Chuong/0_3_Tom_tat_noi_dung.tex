...
Cách tiếp cận được lựa chọn là xây dựng một ứng dụng web dựa trên kiến trúc Client-Server \cite{tanenbaum2010computer}, sử dụng React \cite{react} cho giao diện người dùng và Spring Boot \cite{springboot} cho phía máy chủ, kết hợp với cơ sở dữ liệu PostgreSQL \cite{postgresql}. Lựa chọn này đảm bảo khả năng tương thích đa nền tảng, dễ dàng triển khai và mở rộng, đồng thời cung cấp trải nghiệm người dùng mượt mà nhờ công nghệ Single Page Application (SPA).
